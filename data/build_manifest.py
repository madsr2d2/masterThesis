...
# Resolved 2026-08-31. Exps 127-131 carried pH 7.29, read from a bare "pH" cell
# in a SECOND, unused phosphate block that is identical in all five sheets, while
# the pyrophosphate buffer they actually used is labelled "buffer pH" and steps
# 6.94, 7.41, 8.11, 8.56, 8.98. find_pH_value_in_range now searches the more
# specific label first, so the fix is in the extraction rather than recorded as
# a per-experiment ruling. See DATA_VERIFICATION.md 2026-08-31.
