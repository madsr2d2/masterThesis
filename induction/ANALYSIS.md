...
**20 (62.5%)** resolve a real two-state solution; median `b` over all 31 is
**0.167**, against 0.057 for the temperature series. The five worst failures:
...
**and the failures track pH**: `ρ(pH, b)` = **+0.453** (p = **0.0093**) over
